...
### 62. `codex-agmsg-must-use-git-bash-on-windows`
...
### 63. `agmsg-on-windows-use-git-bash-not-windowsapps-bash`
...
### 65. `mitoya-section-was-two-rows-merged`
...
### 66. `segment-determination-must-come-first`
...
### 67. `lookahead-detection-by-reimplementation`
...
### 68. `v12-debut-multiplier-machine-name-not-number`
...
### 69. `debut-181plus-definition-caveat`
...
### 70. `infer-lr-must-use-x-coordinate`
...
### 71. `walkforward-scoring-is-rule-based-not-ml`
...
### 72. `hit100-equals-winrate-redundancy`
...
### 73. `recommendation-powershell-encoding-required`
...
### 74. `recommendation-machine-master-schema`
- confidence: `0.99` | status: `unverified` | date: `2026-06-21` | file: `2026-06-21-recommendation-top50-workflow-insights.yaml`
- domain/source: `data-pipeline` / `session-observation`
...
### 75. `recommendation-db-path-kamata7-actual`
- confidence: `0.99` | status: `unverified` | date: `2026-06-21` | file: `2026-06-21-recommendation-top50-workflow-insights.yaml`
- domain/source: `data-pipeline` / `session-observation`
...
### 76. `kakuban-alternating-section-reversal-bug`
...
### 77. `dd-band-priority-categorization`
...
### 78. `normalize-segment-frame-essential-columns`
...
### 79. `kamata7-event-day-complete-definition`
...
### 80. `kakuban-colsize-eda-pending-rerun`
...
### 81. `kakuban-colsize-pending-rerun-resolved`
...
### 83. `arm64-apk-x86-emulator-incompatible`
- confidence: `0.99` | status: `unverified` | date: `2026-06-17` | file: `2026-06-17-android-mitmproxy-scraping-insights.yaml`
- domain/source: `mobile-scraping` / `session-observation`
...
### 84. `floor-column-size-definition-correction`
...
### 85. `android-user-cert-app-trust`
...
### 87. `daily-hall-summary-date-features-null-bug`
...
### 88. `rb-probability-juggler-hokuto-spec`
...
### 89. `kabaneri-s-and-l-version-distinction`
...
### 90. `juggler-series-bonus-probability-spec`
...
### 91. `weekday-digit-nth-single-dim-all-null`
...
### 92. `rb-threshold-monkey-hokuto-confirmed`
- confidence: `0.99` | status: `unverified` | date: `2026-06-10` | file: `2026-06-10-eda-anomaly-techbias-insights.yaml`
...
### 93. `firstday-analysis-implementation`
...
### 94. `pre-existing-machine-debut-detection`
...
### 95. `dd-individual-x-day-confirmation`
- confidence: `0.98` | status: `unverified` | date: `2026-06-10` | file: `2026-06-10-eda-anomaly-techbias-insights.yaml`
- domain/source: `eda-pattern` / `empirical-scan`
...
### 96. `anomaly-next-day-mean-reversion`
- confidence: `0.98` | status: `unverified` | date: `2026-06-10` | file: `2026-06-10-eda-anomaly-techbias-insights.yaml`
...
### 97. `mitoya-bari-island-nonexistent`
...
### 98. `python-windows-encoding-japanese-output`
...
### 99. `kakuban-not-rank-terminology`
