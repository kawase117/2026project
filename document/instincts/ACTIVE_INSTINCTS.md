...
- generated_at: 2026-09-11T18:12:46+09:00
- compiler_version: 1.3.0
- source_dir: `C:/Users/apto117/Documents/pachinko-analyzer/src/2026project/document/instincts`
- total_records_scanned: 1583
- active_records: 120
- status_breakdown: unverified=1576, confirmed=1, refuted=0, superseded=5
...
### 2. `hall-mean-residual-flips-sign-on-high-injection-days`
...
### 3. `rule-scores-must-be-decomposed-by-machine`
...
### 4. `model-strength-persists-by-term-not-by-day`
...
### 5. `mitoya-xday-effect-decays-after-manager-change`
...
### 6. `label-position-must-split-by-granularity`
...
### 7. `external-result-corpus-gives-ground-truth-labels`
...
### 8. `2026-09-07-social-collector-silent-truncation`
...
### 9. `2026-09-07-announce-verification-prerequisites`
...
### 10. `2026-09-07-multihall-account-extraction-targeting`
...
### 11. `2026-08-30-frozen-forecast-scope-matrix-answercheck`
...
### 12. `bonus-rate-validity-depends-on-bonus-payout-correlation`
...
### 13. `zentaikei-threshold-is-traffic-dependent`
...
### 14. `at-bonus-column-varies-by-model-and-art-is-separate`
- confidence: `0.85` | status: `unverified` | date: `2026-08-29` | file: `2026-08-29-zentaikei-metric-limits-and-bonus-rate.yaml`
...
### 15. `live-machine-filter-required-not-just-min-machines`
...
### 16. `okidoki-family-not-judgeable`
- confidence: `0.80` | status: `unverified` | date: `2026-08-29` | file: `2026-08-29-zentaikei-metric-limits-and-bonus-rate.yaml`
...
### 17. `hall-traffic-moderates-zentaikei-detection`
...
### 18. `2026-08-01-do-not-use-briefing-common-is-event-dd`
...
### 19. `split-half-consistency-is-not-holdout`
...
### 20. `rakuen-section-column-not-island`
...
### 21. `rb-probability-decimal-null-on-zero-count`
...
### 22. `machine-layout-single-snapshot-breaks-across-renovation`
...
### 23. `uniform-physical-threshold-across-categories-produces-false-anomalies`
...
### 24. `games-filter-is-selection-on-setting`
...
### 25. `diff-coins-confounds-setting-with-turnover`
- confidence: `0.95` | status: `unverified` | date: `2026-07-24` | file: `2026-07-24-deathwatch-rb-null-bug-and-layout-history-insights.yaml`
- domain/source: `statistical-methodology` / `session-observation`
...
### 26. `mwu-cannot-detect-tail-only-edges`
...
### 27. `null-result-requires-power-measurement`
...
### 28. `null-hypothesis-must-preserve-serial-correlation`
- confidence: `0.95` | status: `unverified` | date: `2026-07-23` | file: `2026-07-23-regime-nonstationarity-and-changepoint-insights.yaml`
...
### 29. `metric-choice-decides-what-signal-is-visible`
- confidence: `0.95` | status: `unverified` | date: `2026-07-23` | file: `2026-07-23-regime-nonstationarity-and-changepoint-insights.yaml`
- domain/source: `analysis-methodology` / `session-analysis`
...
### 30. `signal-existence-does-not-imply-predictability`
...
### 31. `preregistration-breaks-in-sample-self-reference`
- confidence: `0.95` | status: `unverified` | date: `2026-07-23` | file: `2026-07-23-prereg-backtest-harness-and-signal-ceiling-insights.yaml`
...
### 32. `emulator-arm64-translation-requires-api34-plus`
...
### 33. `frida-incompatible-with-arm-translation-layer`
...
### 34. `codex-resume-must-go-through-rescue-subagent-not-raw-cli`
...
### 35. `rakuen-diff-unit-is-coins-not-yen`
...
### 36. `rakuen-section-type-a-avoid-always`
...
### 37. `rakuen-honkan-floor-simpson-paradox`
...
### 38. `rakuen-event-day-definition-corrected`
- confidence: `0.95` | status: `unverified` | date: `2026-07-12` | file: `2026-07-12-rakuen-eda-session-insights.yaml`
...
### 39. `prior-distribution-echo-in-self-evaluated-selection-models`
...
### 40. `kakuban-vs-hanaban-terminology-redefinition`
...
### 41. `dataframe-apply-axis1-plus-per-row-series-is-slow`
...
### 42. `codex-desktop-agmsg-monitor-requires-cli-shim-not-desktop-app`
...
### 43. `agmsg-history-vs-inbox-must-not-be-confused-during-debugging`
...
### 44. `kamata7-dashboard-theory-visualization-gaps`
...
### 45. `codex-agmsg-must-use-git-bash-on-windows`
...
### 46. `agmsg-on-windows-use-git-bash-not-windowsapps-bash`
...
### 47. `kamata7-theory-dashboard-needs-japanese-tabs-and-fallbacks`
...
### 48. `cross-agent-dashboard-workflow-claude-design-codex-implementation`
...
### 49. `kamata7-dashboard-routing-must-stay-in-sync-across-main-entrypoints`
...
### 50. `kamata7-event-kind-summary-should-be-machine-count-weighted`
...
### 51. `kamata7-dashboard-initial-scope-safe-top5`
...
### 52. `mitoya-recommend-optimized-weights-never-synced-to-production`
...
### 53. `mitoya-theory-partial-autogeneration-gotcha`
...
### 54. `significance-csv-duplicate-rows-by-outcome`
...
### 55. `dashboard-page-registration-four-files`
...
### 56. `dd30-heatmap-export-tool-available`
...
### 57. `v12b-composite-score-no-calibration`
...
### 58. `v11-segment-weight-concentration-artifact`
...
### 59. `top-n-coverage-vs-precision-tradeoff`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-v12b-calibration-failure-insights.yaml`
...
### 60. `component-calibration-hist-only-signal`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-v12b-calibration-failure-insights.yaml`
...
### 61. `kamata1-section-structure-30sec-350machines`
...
### 62. `kamata1-residual-analysis-no-signal`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-kamata1-eda-step1-3-insights.yaml`
...
### 63. `rakuen-event-dd-not-validated`
...
### 64. `rakuen-2004-2007-bimodal-distribution`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-rakuen-2004-2007-deep-dive-insights.yaml`
...
### 65. `section-ranking-pipeline-final-spec`
...
### 66. `mitoya-coords-section-already-split`
...
### 67. `predict-daily-pipeline-integrated`
...
### 68. `section-daily-pipeline-validated`
...
### 69. `granularity-shift-section-wins-weekly-loses`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-section-daily-pipeline-insights.yaml`
...
### 70. `mitoya-segment-is-section-not-lr-an`
...
### 71. `mitoya-hist-metric-strongest-signal`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-mitoya-calibration-insights.yaml`
...
### 72. `segment-ranking-eval-results`
...
### 74. `segment-discovery-not-physical-gap`
...
### 75. `mitoya-section-was-two-rows-merged`
...
### 76. `segment-determination-must-come-first`
...
### 77. `kamata7-findings-not-transferable-procedure-is`
...
### 78. `kakuban-definition-requires-epsilon-comparison`
...
### 79. `add-debut-phase-index-alignment-bug`
...
### 80. `mitoya-h-nonjug-oddeven-rank-noise-confirmed`
...
### 81. `mitoya-no-pure-digit-effect`
...
### 82. `mitoya-v-nonjug-avoid-segment`
...
### 83. `mitoya-shortlist-min-n-and-existence-check`
...
### 84. `hall-analysis-procedure-six-phases`
...
### 85. `kakuban-is-model-backbone-not-auxiliary`
...
### 86. `lookahead-detection-by-reimplementation`
...
### 87. `v12-debut-multiplier-machine-name-not-number`
...
### 88. `debut-181plus-definition-caveat`
...
### 89. `model-vs-random-segment-divergence`
...
### 90. `insample-cv-overfitting-guard`
- confidence: `0.95` | status: `unverified` | date: `2026-06-26` | file: `2026-06-26-significance-test-design-insights.yaml`
- domain/source: `ml-methodology` / `session-analysis`
...
### 91. `3fln-3frn-subtype-composition-divergence`
- confidence: `0.95` | status: `unverified` | date: `2026-06-26` | file: `2026-06-26-significance-test-design-insights.yaml`
...
### 92. `v12b-near-random-performance-10day`
