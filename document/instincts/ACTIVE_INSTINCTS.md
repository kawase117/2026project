...
- generated_at: 2026-09-11T07:48:49+09:00
- compiler_version: 1.3.0
- source_dir: `C:/Users/apto117/Documents/pachinko-analyzer/src/2026project/document/instincts`
- total_records_scanned: 1579
- active_records: 120
- status_breakdown: unverified=1572, confirmed=1, refuted=0, superseded=5
...
### 1. `rule-scores-must-be-decomposed-by-machine`
...
### 2. `label-position-must-split-by-granularity`
...
### 3. `external-result-corpus-gives-ground-truth-labels`
...
### 4. `2026-09-07-social-collector-silent-truncation`
...
### 5. `2026-09-07-announce-verification-prerequisites`
...
### 6. `2026-09-07-multihall-account-extraction-targeting`
...
### 7. `2026-08-30-frozen-forecast-scope-matrix-answercheck`
...
### 8. `bonus-rate-validity-depends-on-bonus-payout-correlation`
...
### 9. `zentaikei-threshold-is-traffic-dependent`
...
### 10. `at-bonus-column-varies-by-model-and-art-is-separate`
- confidence: `0.85` | status: `unverified` | date: `2026-08-29` | file: `2026-08-29-zentaikei-metric-limits-and-bonus-rate.yaml`
...
### 11. `live-machine-filter-required-not-just-min-machines`
...
### 12. `okidoki-family-not-judgeable`
- confidence: `0.80` | status: `unverified` | date: `2026-08-29` | file: `2026-08-29-zentaikei-metric-limits-and-bonus-rate.yaml`
...
### 13. `hall-traffic-moderates-zentaikei-detection`
...
### 64. `section-daily-pipeline-validated`
...
### 65. `granularity-shift-section-wins-weekly-loses`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-section-daily-pipeline-insights.yaml`
...
### 66. `mitoya-segment-is-section-not-lr-an`
...
### 67. `mitoya-hist-metric-strongest-signal`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-mitoya-calibration-insights.yaml`
...
### 68. `segment-ranking-eval-results`
...
### 70. `segment-discovery-not-physical-gap`
...
### 71. `mitoya-section-was-two-rows-merged`
...
### 72. `segment-determination-must-come-first`
...
### 73. `kamata7-findings-not-transferable-procedure-is`
...
### 74. `kakuban-definition-requires-epsilon-comparison`
...
### 75. `add-debut-phase-index-alignment-bug`
...
### 76. `mitoya-h-nonjug-oddeven-rank-noise-confirmed`
...
### 77. `mitoya-no-pure-digit-effect`
...
### 78. `mitoya-v-nonjug-avoid-segment`
...
### 79. `mitoya-shortlist-min-n-and-existence-check`
...
### 80. `hall-analysis-procedure-six-phases`
...
### 81. `kakuban-is-model-backbone-not-auxiliary`
...
### 82. `lookahead-detection-by-reimplementation`
...
### 83. `v12-debut-multiplier-machine-name-not-number`
...
### 84. `debut-181plus-definition-caveat`
...
### 85. `model-vs-random-segment-divergence`
...
### 86. `insample-cv-overfitting-guard`
- confidence: `0.95` | status: `unverified` | date: `2026-06-26` | file: `2026-06-26-significance-test-design-insights.yaml`
- domain/source: `ml-methodology` / `session-analysis`
...
### 87. `3fln-3frn-subtype-composition-divergence`
- confidence: `0.95` | status: `unverified` | date: `2026-06-26` | file: `2026-06-26-significance-test-design-insights.yaml`
...
### 88. `v12b-near-random-performance-10day`
...
### 89. `scored-pool-streaming-csv-fix`
...
### 90. `predict-daily-pipeline-created`
- confidence: `0.95` | status: `unverified` | date: `2026-06-26` | file: `2026-06-26-lookahead-and-pipeline-insights.yaml`
...
### 91. `seg-percentile-reranking-verified`
...
### 92. `walkforward-memory-limit-scored-pool-accumulation`
