...
- generated_at: 2026-09-11T05:56:31+09:00
- compiler_version: 1.3.0
- source_dir: `C:/Users/apto117/Documents/pachinko-analyzer/src/2026project/document/instincts`
- total_records_scanned: 1578
- active_records: 120
- status_breakdown: unverified=1571, confirmed=1, refuted=0, superseded=5
...
### 1. `label-position-must-split-by-granularity`
...
### 2. `external-result-corpus-gives-ground-truth-labels`
...
### 3. `2026-09-07-social-collector-silent-truncation`
...
### 4. `2026-09-07-announce-verification-prerequisites`
...
### 5. `2026-09-07-multihall-account-extraction-targeting`
...
### 6. `2026-08-30-frozen-forecast-scope-matrix-answercheck`
...
### 7. `bonus-rate-validity-depends-on-bonus-payout-correlation`
...
### 8. `zentaikei-threshold-is-traffic-dependent`
...
### 9. `at-bonus-column-varies-by-model-and-art-is-separate`
- confidence: `0.85` | status: `unverified` | date: `2026-08-29` | file: `2026-08-29-zentaikei-metric-limits-and-bonus-rate.yaml`
...
### 10. `live-machine-filter-required-not-just-min-machines`
...
### 11. `okidoki-family-not-judgeable`
- confidence: `0.80` | status: `unverified` | date: `2026-08-29` | file: `2026-08-29-zentaikei-metric-limits-and-bonus-rate.yaml`
...
### 12. `hall-traffic-moderates-zentaikei-detection`
...
### 13. `2026-08-01-do-not-use-briefing-common-is-event-dd`
...
### 14. `split-half-consistency-is-not-holdout`
...
### 15. `rakuen-section-column-not-island`
...
### 16. `rb-probability-decimal-null-on-zero-count`
...
### 17. `machine-layout-single-snapshot-breaks-across-renovation`
...
### 18. `uniform-physical-threshold-across-categories-produces-false-anomalies`
...
### 19. `games-filter-is-selection-on-setting`
...
### 20. `diff-coins-confounds-setting-with-turnover`
- confidence: `0.95` | status: `unverified` | date: `2026-07-24` | file: `2026-07-24-deathwatch-rb-null-bug-and-layout-history-insights.yaml`
- domain/source: `statistical-methodology` / `session-observation`
...
### 21. `mwu-cannot-detect-tail-only-edges`
...
### 22. `null-result-requires-power-measurement`
...
### 23. `null-hypothesis-must-preserve-serial-correlation`
- confidence: `0.95` | status: `unverified` | date: `2026-07-23` | file: `2026-07-23-regime-nonstationarity-and-changepoint-insights.yaml`
...
### 24. `metric-choice-decides-what-signal-is-visible`
- confidence: `0.95` | status: `unverified` | date: `2026-07-23` | file: `2026-07-23-regime-nonstationarity-and-changepoint-insights.yaml`
- domain/source: `analysis-methodology` / `session-analysis`
...
### 25. `signal-existence-does-not-imply-predictability`
...
### 26. `preregistration-breaks-in-sample-self-reference`
- confidence: `0.95` | status: `unverified` | date: `2026-07-23` | file: `2026-07-23-prereg-backtest-harness-and-signal-ceiling-insights.yaml`
...
### 28. `frida-incompatible-with-arm-translation-layer`
...
### 29. `codex-resume-must-go-through-rescue-subagent-not-raw-cli`
...
### 30. `rakuen-diff-unit-is-coins-not-yen`
...
### 31. `rakuen-section-type-a-avoid-always`
...
### 32. `rakuen-honkan-floor-simpson-paradox`
...
### 33. `rakuen-event-day-definition-corrected`
- confidence: `0.95` | status: `unverified` | date: `2026-07-12` | file: `2026-07-12-rakuen-eda-session-insights.yaml`
...
### 34. `prior-distribution-echo-in-self-evaluated-selection-models`
...
### 35. `kakuban-vs-hanaban-terminology-redefinition`
...
### 36. `dataframe-apply-axis1-plus-per-row-series-is-slow`
...
### 37. `codex-desktop-agmsg-monitor-requires-cli-shim-not-desktop-app`
...
### 38. `agmsg-history-vs-inbox-must-not-be-confused-during-debugging`
...
### 39. `kamata7-dashboard-theory-visualization-gaps`
...
### 40. `codex-agmsg-must-use-git-bash-on-windows`
...
### 41. `agmsg-on-windows-use-git-bash-not-windowsapps-bash`
...
### 42. `kamata7-theory-dashboard-needs-japanese-tabs-and-fallbacks`
...
### 43. `cross-agent-dashboard-workflow-claude-design-codex-implementation`
...
### 44. `kamata7-dashboard-routing-must-stay-in-sync-across-main-entrypoints`
...
### 45. `kamata7-event-kind-summary-should-be-machine-count-weighted`
...
### 46. `kamata7-dashboard-initial-scope-safe-top5`
...
### 47. `mitoya-recommend-optimized-weights-never-synced-to-production`
...
### 48. `mitoya-theory-partial-autogeneration-gotcha`
...
### 49. `significance-csv-duplicate-rows-by-outcome`
...
### 50. `dashboard-page-registration-four-files`
...
### 51. `dd30-heatmap-export-tool-available`
...
### 52. `v12b-composite-score-no-calibration`
...
### 53. `v11-segment-weight-concentration-artifact`
...
### 54. `top-n-coverage-vs-precision-tradeoff`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-v12b-calibration-failure-insights.yaml`
...
### 55. `component-calibration-hist-only-signal`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-v12b-calibration-failure-insights.yaml`
...
### 56. `kamata1-section-structure-30sec-350machines`
...
### 57. `kamata1-residual-analysis-no-signal`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-kamata1-eda-step1-3-insights.yaml`
...
### 58. `rakuen-event-dd-not-validated`
...
### 59. `rakuen-2004-2007-bimodal-distribution`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-rakuen-2004-2007-deep-dive-insights.yaml`
...
### 60. `section-ranking-pipeline-final-spec`
...
### 61. `mitoya-coords-section-already-split`
...
### 62. `predict-daily-pipeline-integrated`
...
### 63. `section-daily-pipeline-validated`
...
### 64. `granularity-shift-section-wins-weekly-loses`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-section-daily-pipeline-insights.yaml`
...
### 65. `mitoya-segment-is-section-not-lr-an`
...
### 66. `mitoya-hist-metric-strongest-signal`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-mitoya-calibration-insights.yaml`
...
### 67. `segment-ranking-eval-results`
...
### 69. `segment-discovery-not-physical-gap`
...
### 70. `mitoya-section-was-two-rows-merged`
...
### 71. `segment-determination-must-come-first`
...
### 72. `kamata7-findings-not-transferable-procedure-is`
...
### 73. `kakuban-definition-requires-epsilon-comparison`
...
### 74. `add-debut-phase-index-alignment-bug`
...
### 75. `mitoya-h-nonjug-oddeven-rank-noise-confirmed`
...
### 76. `mitoya-no-pure-digit-effect`
...
### 77. `mitoya-v-nonjug-avoid-segment`
...
### 78. `mitoya-shortlist-min-n-and-existence-check`
...
### 79. `hall-analysis-procedure-six-phases`
...
### 80. `kakuban-is-model-backbone-not-auxiliary`
...
### 81. `lookahead-detection-by-reimplementation`
...
### 82. `v12-debut-multiplier-machine-name-not-number`
...
### 83. `debut-181plus-definition-caveat`
...
### 84. `model-vs-random-segment-divergence`
...
### 85. `insample-cv-overfitting-guard`
- confidence: `0.95` | status: `unverified` | date: `2026-06-26` | file: `2026-06-26-significance-test-design-insights.yaml`
- domain/source: `ml-methodology` / `session-analysis`
...
### 86. `3fln-3frn-subtype-composition-divergence`
- confidence: `0.95` | status: `unverified` | date: `2026-06-26` | file: `2026-06-26-significance-test-design-insights.yaml`
...
### 87. `v12b-near-random-performance-10day`
...
### 88. `scored-pool-streaming-csv-fix`
...
### 89. `predict-daily-pipeline-created`
- confidence: `0.95` | status: `unverified` | date: `2026-06-26` | file: `2026-06-26-lookahead-and-pipeline-insights.yaml`
...
### 90. `seg-percentile-reranking-verified`
...
### 91. `walkforward-memory-limit-scored-pool-accumulation`
...
### 92. `payout-rate-weighted-avg-mandatory`
- confidence: `0.95` | status: `unverified` | date: `2026-06-26` | file: `2026-06-26-track-b-a1-evaluation-insights.yaml`
