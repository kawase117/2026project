...
- generated_at: 2026-06-23T21:44:44+09:00
- compiler_version: 1.2.0
- source_dir: `C:/Users/apto117/Documents/pachinko-analyzer/src/2026project/document/instincts`
- total_records_scanned: 993
- active_records: 120
- status_breakdown: unverified=992, confirmed=0, refuted=0, superseded=0
...
### 1. `daily-hall-summary-date-features-null-bug`
...
### 2. `rb-probability-juggler-hokuto-spec`
...
### 3. `kabaneri-s-and-l-version-distinction`
...
### 4. `juggler-series-bonus-probability-spec`
...
### 5. `infer-lr-must-use-x-coordinate`
...
### 6. `walkforward-scoring-is-rule-based-not-ml`
...
### 7. `hit100-equals-winrate-redundancy`
...
### 8. `recommendation-powershell-encoding-required`
...
### 9. `recommendation-machine-master-schema`
- confidence: `0.99` | status: `unverified` | date: `2026-06-21` | file: `2026-06-21-recommendation-top50-workflow-insights.yaml`
...
### 10. `recommendation-db-path-kamata7-actual`
- confidence: `0.99` | status: `unverified` | date: `2026-06-21` | file: `2026-06-21-recommendation-top50-workflow-insights.yaml`
- domain/source: `data-pipeline` / `session-observation`
...
### 11. `kakuban-alternating-section-reversal-bug`
...
### 12. `kakuban-colsize-eda-pending-rerun`
...
### 13. `kakuban-colsize-pending-rerun-resolved`
...
### 15. `arm64-apk-x86-emulator-incompatible`
- confidence: `0.99` | status: `unverified` | date: `2026-06-17` | file: `2026-06-17-android-mitmproxy-scraping-insights.yaml`
- domain/source: `mobile-scraping` / `session-observation`
...
### 17. `weekday-digit-nth-single-dim-all-null`
...
### 18. `rb-threshold-monkey-hokuto-confirmed`
- confidence: `0.99` | status: `unverified` | date: `2026-06-10` | file: `2026-06-10-eda-anomaly-techbias-insights.yaml`
...
### 19. `firstday-analysis-implementation`
...
### 20. `mitoya-bari-island-nonexistent`
...
### 21. `python-windows-encoding-japanese-output`
...
### 22. `kakuban-not-rank-terminology`
...
### 23. `full-2025-window-boundary-safety`
...
### 26. `catboost-gpu-ndcg-not-implemented`
...
### 27. `walrus-operator-parameter-overwrite`
...
### 28. `poco-is-post-hoc-not-realtime`
...
### 30. `instinct-contamination-two-types`
...
### 31. `adjusted-lift-denominator-10-not-9`
...
### 32. `instinct-scope-taxonomy-rule`
...
### 33. `hall-specific-findings-never-transfer-to-other-halls`
- confidence: `0.99` | status: `unverified` | date: `2026-06-01` | file: `2026-06-01-hall-independence-principle.yaml`
...
### 34. `signal-existence-must-precede-ml-design`
...
### 35. `leakage-check-direction-must-be-inclusion-not-exclusion`
...
### 36. `grid-search-exposes-narrow-space-artifacts`
...
### 37. `total-diff-coins-focus-leakage-root-cause`
...
### 38. `dd-value-missing-from-features`
...
### 39. `signal-correlation-json-output-keys`
...
### 40. `kamata7-floor-classification`
...
### 41. `correct-segment-classification-floor-atype4`
...
### 42. `is-top2-must-be-within-expert`
...
### 43. `window-name-vs-feature-name-confusion`
...
### 44. `dd-band-priority-categorization`
...
### 45. `normalize-segment-frame-essential-columns`
...
### 46. `kamata7-event-day-complete-definition`
...
### 47. `floor-column-size-definition-correction`
...
### 48. `android-user-cert-app-trust`
...
### 49. `pre-existing-machine-debut-detection`
...
### 50. `dd-individual-x-day-confirmation`
- confidence: `0.98` | status: `unverified` | date: `2026-06-10` | file: `2026-06-10-eda-anomaly-techbias-insights.yaml`
- domain/source: `eda-pattern` / `empirical-scan`
...
### 51. `anomaly-next-day-mean-reversion`
- confidence: `0.98` | status: `unverified` | date: `2026-06-10` | file: `2026-06-10-eda-anomaly-techbias-insights.yaml`
...
### 52. `machine-name-contamination-in-ml-training`
...
### 53. `mitoya-daily-hall-summary-null-flags`
...
### 54. `forecast-excluded-columns-leakage-guard`
...
### 55. `bucket-specific-hall-average-baseline`
...
### 56. `dd-vs-xday-definition-clarification`
...
### 57. `make-binary-model-gpu-branch-bug`
...
### 58. `sql-injection-fstring-table-name`
...
### 59. `bare-except-swallows-keyboard-interrupt`
- confidence: `0.98` | status: `unverified` | date: `2026-06-05` | file: `2026-06-05-code-review-security-ml-insights.yaml`
- domain/source: `python-bugs` / `session-observation`
...
### 60. `poco-partial-status-multi-machine-mapping`
...
### 61. `machine-name-alias-normalization-critical`
...
### 62. `approach-transfer-vs-findings-transfer`
...
### 63. `hit-at-2-binary-vs-precision-confusion`
...
### 64. `hard-miss-vs-exact-miss-definition`
...
### 65. `top3-output-already-implemented-per-expert`
...
### 66. `anomaly-db-scope-must-be-single-hall`
...
### 67. `outcome-leakage-vs-target-leakage-are-different`
...
### 68. `always-2fn-beats-all-calendar-rules`
...
### 69. `live-vs-backtest-gap-explained-by-leakage`
...
### 70. `pred-span-vs-pred-span-top12-are-different`
...
### 71. `segment-specific-top3-comparison`
...
### 72. `progress-reporting-required-in-all-loops`
...
### 73. `top50-is-delivery-format-not-target`
...
### 74. `kakuban-strongest-structural-signal`
...
### 75. `x-kakuban-rank-must-be-per-machine-not-per-row`
...
### 76. `kakuban-1-universal-avoidance-colsize-confirmed`
...
### 77. `3f-short-single-section-analysis-invalid`
- confidence: `0.97` | status: `unverified` | date: `2026-06-17` | file: `2026-06-17-kakuban-colsize-newresults-insights.yaml`
- domain/source: `analysis-methodology` / `session-observation`
...
### 79. `kakuban-dual-rank-correct-definition`
...
### 80. `sqlite-groupby-arbitrary-machine-name`
...
### 81. `kamata1-jag-hana-name-filter`
...
### 82. `new-machine-low-setting-start-confirmed`
...
### 83. `kamata7-7kei-monday-strongest-signal`
- confidence: `0.97` | status: `unverified` | date: `2026-06-10` | file: `2026-06-10-eda-anomaly-techbias-insights.yaml`
- domain/source: `eda-pattern` / `empirical-scan`
...
### 84. `anomaly-early-debut-unreliable`
- confidence: `0.97` | status: `unverified` | date: `2026-06-10` | file: `2026-06-10-eda-anomaly-techbias-insights.yaml`
- domain/source: `anomaly-detection` / `empirical-analysis`
...
### 85. `hall-firstday-kaiwari-ranking-arrow-mitoya-top`
...
### 86. `hall-firstday-104pct-threshold-ranking`
- confidence: `0.97` | status: `unverified` | date: `2026-06-10` | file: `2026-06-10-new-machine-firstday-hall-insights.yaml`
- domain/source: `hall-strategy` / `empirical-analysis`
...
### 87. `hall-specific-vs-universal-patterns-equal-value`
...
### 88. `catboost-windows-py314-bad-allocation-warmup`
...
### 89. `is-far-corner-reversed-section-bug`
...
### 90. `anaslo-l-prefix-first-day-behavior`
...
### 91. `reversed-sections-in-hall-config-not-code`
...
### 92. `xday-weekday-confounding-ruled-out`
...
### 93. `verify-current-placement-before-dd-eda`
...
### 94. `month-dd-seasonality-requires-3plus-years`
...
### 95. `mitoya-group-level-position-aggregation`
...
### 96. `margin-threshold-is-primary-adoption-filter`
...
### 97. `strong-zorome-date-computation`
...
### 98. `model-excess-vs-absolute-return`
- confidence: `0.97` | status: `unverified` | date: `2026-06-05` | file: `2026-06-05-mitoya-bucket-design-insights.yaml`
- domain/source: `methodology` / `session-observation`
...
### 99. `narabi-jug-other-split-anchor`
...
### 100. `hall-selection-vs-tail-ranking-model-separation`
...
### 101. `ml-rolling-stats-shift1-leakage`
...
### 102. `poco-signal-strength-quantified`
...
### 103. `poco-format-three-variants`
...
### 104. `random-baseline-negative-hall-selection-critical`
...
### 105. `data-observation-is-leakage-immune`
...
### 106. `group-total-diff-is-not-per-machine`
...
### 107. `weak-p-value-with-multiple-segments-is-artifact`
...
### 108. `calendar-features-hurt-means-non-stationary`
- confidence: `0.97` | status: `unverified` | date: `2026-06-01` | file: `2026-06-01-signal-existence-insights.yaml`
- domain/source: `ml-architecture` / `data-analysis`
...
### 109. `empirical-leakage-detection-over-code-review`
- confidence: `0.97` | status: `unverified` | date: `2026-05-31` | file: `2026-05-31-leakage-protocol-insights.yaml`
- domain/source: `prediction-evaluation` / `session-observation`
...
### 110. `deviation-rule-uplift-cost-is-large`
- confidence: `0.97` | status: `unverified` | date: `2026-06-01` | file: `2026-06-01-segment-strategy-insights.yaml`
- domain/source: `domain-strategy` / `data-analysis`
...
### 111. `classification-metrics-mislead-for-uplift-problems`
- confidence: `0.97` | status: `unverified` | date: `2026-06-01` | file: `2026-06-01-segment-strategy-insights.yaml`
- domain/source: `prediction-evaluation` / `data-analysis`
...
### 112. `leakage-diagnosis-three-step-procedure`
- confidence: `0.97` | status: `unverified` | date: `2026-05-31` | file: `2026-05-31-leakage-diagnosis-insights.yaml`
- domain/source: `prediction-evaluation` / `data-analysis`
...
### 113. `backtest-saturation-is-reliability-alarm`
- confidence: `0.97` | status: `unverified` | date: `2026-05-31` | file: `2026-05-31-evaluation-feature-insights.yaml`
- domain/source: `prediction-evaluation` / `data-analysis`
...
### 114. `hokuto-machine-name-disambiguation`
- confidence: `0.97` | status: `unverified` | date: `2026-05-28` | file: `2026-05-28-signal-machine-analysis-insights.yaml`
- domain/source: `operational-strategy` / `session-observation`
...
### 115. `tail-vs-zorome-machine-separate-evaluation`
- confidence: `0.97` | status: `unverified` | date: `2026-05-28` | file: `2026-05-28-codex-analysis-improvements.yaml`
...
### 116. `train-eval-alignment-check-mandatory`
- confidence: `0.97` | status: `unverified` | date: `2026-05-25` | file: `2026-05-25-within-expert-target-fix.yaml`
...
### 117. `python-module-vs-script-execution`
- confidence: `0.97` | status: `unverified` | date: `2026-05-25` | file: `2026-05-25-ltr-feature-engineering-insights.yaml`
...
### 118. `machine-master-flag-keyword-based`
- confidence: `0.97` | status: `unverified` | date: `2026-05-21` | file: `2026-05-21-machine-master-flag-system.yaml`
