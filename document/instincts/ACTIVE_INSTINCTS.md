...
- generated_at: 2026-09-16T08:18:10+09:00
- compiler_version: 1.3.0
- source_dir: `C:/Users/apto117/Documents/pachinko-analyzer/src/2026project/document/instincts`
- total_records_scanned: 1593
- active_records: 120
- status_breakdown: unverified=1585, confirmed=1, refuted=0, superseded=6
...
### 1. `kamata7-tuesday-kakuban-is-section-end-minmax`
...
### 2. `realtime-field-observation-is-not-blind-prediction`
...
### 3. `machine-level-highsetting-estimator-validity`
...
### 4. `whole-period-aggregates-hide-regime-changes`
...
### 5. `absolute-and-relative-coins-answer-different-questions`
...
### 6. `hall-mean-residual-flips-sign-on-high-injection-days`
...
### 7. `rule-scores-must-be-decomposed-by-machine`
...
### 8. `hall-raises-a-subset-not-everything`
...
### 9. `date-conditions-choose-the-day-not-the-model`
...
### 10. `model-strength-persists-by-term-not-by-day`
...
### 11. `mitoya-xday-effect-decays-after-manager-change`
...
### 12. `label-position-must-split-by-granularity`
...
### 13. `external-result-corpus-gives-ground-truth-labels`
...
### 14. `2026-09-07-social-collector-silent-truncation`
...
### 15. `2026-09-07-announce-verification-prerequisites`
...
### 16. `2026-09-07-multihall-account-extraction-targeting`
...
### 17. `2026-08-30-frozen-forecast-scope-matrix-answercheck`
...
### 18. `bonus-rate-validity-depends-on-bonus-payout-correlation`
...
### 19. `zentaikei-threshold-is-traffic-dependent`
...
### 20. `at-bonus-column-varies-by-model-and-art-is-separate`
- confidence: `0.85` | status: `unverified` | date: `2026-08-29` | file: `2026-08-29-zentaikei-metric-limits-and-bonus-rate.yaml`
...
### 21. `live-machine-filter-required-not-just-min-machines`
...
### 22. `okidoki-family-not-judgeable`
- confidence: `0.80` | status: `unverified` | date: `2026-08-29` | file: `2026-08-29-zentaikei-metric-limits-and-bonus-rate.yaml`
...
### 23. `hall-traffic-moderates-zentaikei-detection`
...
### 24. `2026-08-01-do-not-use-briefing-common-is-event-dd`
...
### 25. `split-half-consistency-is-not-holdout`
...
### 26. `rakuen-section-column-not-island`
...
### 29. `uniform-physical-threshold-across-categories-produces-false-anomalies`
...
### 30. `games-filter-is-selection-on-setting`
...
### 31. `diff-coins-confounds-setting-with-turnover`
- confidence: `0.95` | status: `unverified` | date: `2026-07-24` | file: `2026-07-24-deathwatch-rb-null-bug-and-layout-history-insights.yaml`
- domain/source: `statistical-methodology` / `session-observation`
...
### 32. `mwu-cannot-detect-tail-only-edges`
...
### 33. `null-result-requires-power-measurement`
...
### 34. `null-hypothesis-must-preserve-serial-correlation`
- confidence: `0.95` | status: `unverified` | date: `2026-07-23` | file: `2026-07-23-regime-nonstationarity-and-changepoint-insights.yaml`
...
### 35. `metric-choice-decides-what-signal-is-visible`
- confidence: `0.95` | status: `unverified` | date: `2026-07-23` | file: `2026-07-23-regime-nonstationarity-and-changepoint-insights.yaml`
- domain/source: `analysis-methodology` / `session-analysis`
...
### 36. `signal-existence-does-not-imply-predictability`
...
### 37. `preregistration-breaks-in-sample-self-reference`
- confidence: `0.95` | status: `unverified` | date: `2026-07-23` | file: `2026-07-23-prereg-backtest-harness-and-signal-ceiling-insights.yaml`
...
### 38. `emulator-arm64-translation-requires-api34-plus`
...
### 39. `frida-incompatible-with-arm-translation-layer`
...
### 40. `codex-resume-must-go-through-rescue-subagent-not-raw-cli`
...
### 41. `rakuen-diff-unit-is-coins-not-yen`
...
### 42. `rakuen-section-type-a-avoid-always`
...
### 43. `rakuen-honkan-floor-simpson-paradox`
...
### 44. `rakuen-event-day-definition-corrected`
- confidence: `0.95` | status: `unverified` | date: `2026-07-12` | file: `2026-07-12-rakuen-eda-session-insights.yaml`
...
### 45. `prior-distribution-echo-in-self-evaluated-selection-models`
...
### 46. `kakuban-vs-hanaban-terminology-redefinition`
...
### 47. `dataframe-apply-axis1-plus-per-row-series-is-slow`
...
### 48. `codex-desktop-agmsg-monitor-requires-cli-shim-not-desktop-app`
...
### 49. `agmsg-history-vs-inbox-must-not-be-confused-during-debugging`
...
### 50. `kamata7-dashboard-theory-visualization-gaps`
...
### 51. `codex-agmsg-must-use-git-bash-on-windows`
...
### 52. `agmsg-on-windows-use-git-bash-not-windowsapps-bash`
...
### 53. `kamata7-theory-dashboard-needs-japanese-tabs-and-fallbacks`
...
### 54. `cross-agent-dashboard-workflow-claude-design-codex-implementation`
...
### 55. `kamata7-dashboard-routing-must-stay-in-sync-across-main-entrypoints`
...
### 56. `kamata7-event-kind-summary-should-be-machine-count-weighted`
...
### 57. `kamata7-dashboard-initial-scope-safe-top5`
...
### 58. `mitoya-recommend-optimized-weights-never-synced-to-production`
...
### 59. `mitoya-theory-partial-autogeneration-gotcha`
...
### 60. `significance-csv-duplicate-rows-by-outcome`
...
### 61. `dashboard-page-registration-four-files`
...
### 62. `dd30-heatmap-export-tool-available`
...
### 64. `v11-segment-weight-concentration-artifact`
...
### 65. `top-n-coverage-vs-precision-tradeoff`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-v12b-calibration-failure-insights.yaml`
...
### 66. `component-calibration-hist-only-signal`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-v12b-calibration-failure-insights.yaml`
...
### 67. `kamata1-section-structure-30sec-350machines`
...
### 68. `kamata1-residual-analysis-no-signal`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-kamata1-eda-step1-3-insights.yaml`
...
### 69. `rakuen-event-dd-not-validated`
...
### 70. `rakuen-2004-2007-bimodal-distribution`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-rakuen-2004-2007-deep-dive-insights.yaml`
...
### 71. `section-ranking-pipeline-final-spec`
...
### 72. `mitoya-coords-section-already-split`
...
### 73. `predict-daily-pipeline-integrated`
...
### 74. `section-daily-pipeline-validated`
...
### 75. `granularity-shift-section-wins-weekly-loses`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-section-daily-pipeline-insights.yaml`
...
### 76. `mitoya-segment-is-section-not-lr-an`
...
### 77. `mitoya-hist-metric-strongest-signal`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-mitoya-calibration-insights.yaml`
...
### 78. `segment-ranking-eval-results`
...
### 80. `segment-discovery-not-physical-gap`
...
### 81. `mitoya-section-was-two-rows-merged`
...
### 82. `segment-determination-must-come-first`
...
### 83. `kamata7-findings-not-transferable-procedure-is`
...
### 84. `kakuban-definition-requires-epsilon-comparison`
...
### 85. `add-debut-phase-index-alignment-bug`
...
### 86. `mitoya-h-nonjug-oddeven-rank-noise-confirmed`
...
### 87. `mitoya-no-pure-digit-effect`
...
### 88. `lookahead-detection-by-reimplementation`
...
### 89. `v12-debut-multiplier-machine-name-not-number`
...
### 90. `debut-181plus-definition-caveat`
...
### 91. `model-vs-random-segment-divergence`
...
### 92. `insample-cv-overfitting-guard`
- confidence: `0.95` | status: `unverified` | date: `2026-06-26` | file: `2026-06-26-significance-test-design-insights.yaml`
- domain/source: `ml-methodology` / `session-analysis`
...
### 93. `3fln-3frn-subtype-composition-divergence`
- confidence: `0.95` | status: `unverified` | date: `2026-06-26` | file: `2026-06-26-significance-test-design-insights.yaml`
...
### 94. `infer-lr-must-use-x-coordinate`
...
### 95. `walkforward-scoring-is-rule-based-not-ml`
...
### 96. `hit100-equals-winrate-redundancy`
...
### 97. `top50-is-delivery-format-not-target`
...
### 98. `recommendation-powershell-encoding-required`
...
### 99. `recommendation-machine-master-schema`
- confidence: `0.99` | status: `unverified` | date: `2026-06-21` | file: `2026-06-21-recommendation-top50-workflow-insights.yaml`
- domain/source: `data-pipeline` / `session-observation`
...
### 100. `recommendation-db-path-kamata7-actual`
- confidence: `0.99` | status: `unverified` | date: `2026-06-21` | file: `2026-06-21-recommendation-top50-workflow-insights.yaml`
- domain/source: `data-pipeline` / `session-observation`
...
### 101. `kakuban-alternating-section-reversal-bug`
...
### 102. `dd-band-priority-categorization`
...
### 103. `normalize-segment-frame-essential-columns`
...
### 104. `kamata7-event-day-complete-definition`
...
### 105. `kakuban-strongest-structural-signal`
...
### 106. `daily-level-anova-for-group-size-bias-avoidance`
...
### 107. `distinguish-actual-value-from-category`
...
### 108. `x-kakuban-rank-must-be-per-machine-not-per-row`
...
### 109. `kakuban-colsize-eda-pending-rerun`
...
### 110. `kakuban-colsize-pending-rerun-resolved`
...
### 112. `arm64-apk-x86-emulator-incompatible`
- confidence: `0.99` | status: `unverified` | date: `2026-06-17` | file: `2026-06-17-android-mitmproxy-scraping-insights.yaml`
- domain/source: `mobile-scraping` / `session-observation`
...
### 113. `floor-column-size-definition-correction`
...
### 114. `android-user-cert-app-trust`
...
### 115. `kakuban-1-universal-avoidance-colsize-confirmed`
...
### 116. `3f-short-single-section-analysis-invalid`
- confidence: `0.97` | status: `unverified` | date: `2026-06-17` | file: `2026-06-17-kakuban-colsize-newresults-insights.yaml`
- domain/source: `analysis-methodology` / `session-observation`
...
### 117. `split-apk-install-multiple`
...
### 118. `kakuban-dual-rank-correct-definition`
...
### 119. `sqlite-groupby-arbitrary-machine-name`
...
### 120. `kamata1-jag-hana-name-filter`
