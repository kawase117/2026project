...
- generated_at: 2026-09-11T19:56:21+09:00
- compiler_version: 1.3.0
- source_dir: `C:/Users/apto117/Documents/pachinko-analyzer/src/2026project/document/instincts`
- total_records_scanned: 1584
- active_records: 120
- status_breakdown: unverified=1577, confirmed=1, refuted=0, superseded=5
...
### 4. `date-conditions-choose-the-day-not-the-model`
...
### 5. `model-strength-persists-by-term-not-by-day`
...
### 6. `mitoya-xday-effect-decays-after-manager-change`
...
### 7. `label-position-must-split-by-granularity`
...
### 8. `external-result-corpus-gives-ground-truth-labels`
...
### 9. `2026-09-07-social-collector-silent-truncation`
...
### 10. `2026-09-07-announce-verification-prerequisites`
...
### 11. `2026-09-07-multihall-account-extraction-targeting`
...
### 12. `2026-08-30-frozen-forecast-scope-matrix-answercheck`
...
### 13. `bonus-rate-validity-depends-on-bonus-payout-correlation`
...
### 14. `zentaikei-threshold-is-traffic-dependent`
...
### 15. `at-bonus-column-varies-by-model-and-art-is-separate`
- confidence: `0.85` | status: `unverified` | date: `2026-08-29` | file: `2026-08-29-zentaikei-metric-limits-and-bonus-rate.yaml`
...
### 16. `live-machine-filter-required-not-just-min-machines`
...
### 17. `okidoki-family-not-judgeable`
- confidence: `0.80` | status: `unverified` | date: `2026-08-29` | file: `2026-08-29-zentaikei-metric-limits-and-bonus-rate.yaml`
...
### 18. `hall-traffic-moderates-zentaikei-detection`
...
### 19. `2026-08-01-do-not-use-briefing-common-is-event-dd`
...
### 20. `split-half-consistency-is-not-holdout`
...
### 21. `rakuen-section-column-not-island`
...
### 22. `rb-probability-decimal-null-on-zero-count`
...
### 23. `machine-layout-single-snapshot-breaks-across-renovation`
...
### 24. `uniform-physical-threshold-across-categories-produces-false-anomalies`
...
### 25. `games-filter-is-selection-on-setting`
...
### 26. `diff-coins-confounds-setting-with-turnover`
- confidence: `0.95` | status: `unverified` | date: `2026-07-24` | file: `2026-07-24-deathwatch-rb-null-bug-and-layout-history-insights.yaml`
- domain/source: `statistical-methodology` / `session-observation`
...
### 27. `mwu-cannot-detect-tail-only-edges`
...
### 28. `null-result-requires-power-measurement`
...
### 29. `null-hypothesis-must-preserve-serial-correlation`
- confidence: `0.95` | status: `unverified` | date: `2026-07-23` | file: `2026-07-23-regime-nonstationarity-and-changepoint-insights.yaml`
...
### 30. `metric-choice-decides-what-signal-is-visible`
- confidence: `0.95` | status: `unverified` | date: `2026-07-23` | file: `2026-07-23-regime-nonstationarity-and-changepoint-insights.yaml`
- domain/source: `analysis-methodology` / `session-analysis`
...
### 31. `signal-existence-does-not-imply-predictability`
...
### 32. `preregistration-breaks-in-sample-self-reference`
- confidence: `0.95` | status: `unverified` | date: `2026-07-23` | file: `2026-07-23-prereg-backtest-harness-and-signal-ceiling-insights.yaml`
...
### 33. `emulator-arm64-translation-requires-api34-plus`
...
### 34. `frida-incompatible-with-arm-translation-layer`
...
### 35. `codex-resume-must-go-through-rescue-subagent-not-raw-cli`
...
### 36. `rakuen-diff-unit-is-coins-not-yen`
...
### 37. `rakuen-section-type-a-avoid-always`
...
### 38. `rakuen-honkan-floor-simpson-paradox`
...
### 39. `rakuen-event-day-definition-corrected`
- confidence: `0.95` | status: `unverified` | date: `2026-07-12` | file: `2026-07-12-rakuen-eda-session-insights.yaml`
...
### 40. `prior-distribution-echo-in-self-evaluated-selection-models`
...
### 41. `kakuban-vs-hanaban-terminology-redefinition`
...
### 42. `dataframe-apply-axis1-plus-per-row-series-is-slow`
...
### 43. `codex-desktop-agmsg-monitor-requires-cli-shim-not-desktop-app`
...
### 44. `agmsg-history-vs-inbox-must-not-be-confused-during-debugging`
...
### 45. `kamata7-dashboard-theory-visualization-gaps`
...
### 46. `codex-agmsg-must-use-git-bash-on-windows`
...
### 48. `kamata7-theory-dashboard-needs-japanese-tabs-and-fallbacks`
...
### 49. `cross-agent-dashboard-workflow-claude-design-codex-implementation`
...
### 50. `kamata7-dashboard-routing-must-stay-in-sync-across-main-entrypoints`
...
### 51. `kamata7-event-kind-summary-should-be-machine-count-weighted`
...
### 52. `kamata7-dashboard-initial-scope-safe-top5`
...
### 53. `mitoya-recommend-optimized-weights-never-synced-to-production`
...
### 54. `mitoya-theory-partial-autogeneration-gotcha`
...
### 55. `significance-csv-duplicate-rows-by-outcome`
...
### 56. `dashboard-page-registration-four-files`
...
### 57. `dd30-heatmap-export-tool-available`
...
### 58. `v12b-composite-score-no-calibration`
...
### 59. `v11-segment-weight-concentration-artifact`
...
### 60. `top-n-coverage-vs-precision-tradeoff`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-v12b-calibration-failure-insights.yaml`
...
### 61. `component-calibration-hist-only-signal`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-v12b-calibration-failure-insights.yaml`
...
### 62. `kamata1-section-structure-30sec-350machines`
...
### 63. `kamata1-residual-analysis-no-signal`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-kamata1-eda-step1-3-insights.yaml`
...
### 64. `rakuen-event-dd-not-validated`
...
### 65. `rakuen-2004-2007-bimodal-distribution`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-rakuen-2004-2007-deep-dive-insights.yaml`
...
### 66. `section-ranking-pipeline-final-spec`
...
### 67. `mitoya-coords-section-already-split`
...
### 68. `predict-daily-pipeline-integrated`
...
### 69. `section-daily-pipeline-validated`
...
### 70. `granularity-shift-section-wins-weekly-loses`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-section-daily-pipeline-insights.yaml`
...
### 71. `mitoya-segment-is-section-not-lr-an`
...
### 72. `mitoya-hist-metric-strongest-signal`
- confidence: `0.95` | status: `unverified` | date: `2026-06-29` | file: `2026-06-29-mitoya-calibration-insights.yaml`
...
### 73. `segment-ranking-eval-results`
...
### 75. `segment-discovery-not-physical-gap`
...
### 76. `mitoya-section-was-two-rows-merged`
...
### 77. `segment-determination-must-come-first`
...
### 78. `kamata7-findings-not-transferable-procedure-is`
...
### 79. `kakuban-definition-requires-epsilon-comparison`
...
### 80. `add-debut-phase-index-alignment-bug`
...
### 81. `mitoya-h-nonjug-oddeven-rank-noise-confirmed`
...
### 82. `mitoya-no-pure-digit-effect`
...
### 83. `mitoya-v-nonjug-avoid-segment`
...
### 84. `mitoya-shortlist-min-n-and-existence-check`
...
### 85. `hall-analysis-procedure-six-phases`
...
### 86. `kakuban-is-model-backbone-not-auxiliary`
