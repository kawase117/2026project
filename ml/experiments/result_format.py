...
def build_run_payload(
    ...
    *,
    ...
    """Convert a flat experiment log into the structured bundle payload."""
...
def render_run_summary_html(run_data: dict[str, Any]) -> str:
    """Render a fixed-structure standalone HTML summary for one run."""
...
def build_index_record(run_payload: dict[str, Any], run_json_path: Path, results_dir: Path) -> dict[str, Any]:
    """Create a compact index entry for search/filter use."""
