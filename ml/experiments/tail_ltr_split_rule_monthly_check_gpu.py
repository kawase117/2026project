...
from ml.experiments.tail_ltr_split_rule_nextday_gpu import _build_reliability_daily, _build_reliability_monthly
from ml.experiments.tail_ltr_split_rule_wf import parse_csv_strs
...
def main() -> int:
    ...
    cmd = [
        sys.executable,
        "-m",
        "ml.experiments.tail_ltr_split_rule_wf",
        "--output-prefix",
        str(out_prefix),
        "--seeds",
        args.seeds,
