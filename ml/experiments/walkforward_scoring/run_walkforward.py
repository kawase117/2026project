...
from .walk_forward_engine import load_machine_data, run_backtest
...
def main(argv: list[str] | None = None) -> int:
    ...
    variants = None if args.variants == "all" else tuple(value.strip() for value in args.variants.split(",") if value.strip())
