...
- anomaly_direction / low_anomaly / loss_value: delta=-2500.0000, p_bh=0.03342, d=-0.795 (medium)
- anomaly_direction / normal / loss_value: delta=-1050.4000, p_bh=0.0001413, d=-0.242 (small)
- weekday / Monday / loss_value: delta=-866.6667, p_bh=0.04115, d=-0.297 (small)
- weekday / Saturday / rank2_rescue_on_miss1: delta=0.7000, p_bh=0.03653, d=1.807 (large)
- weekday / Wednesday / rank2_rescue_on_miss1: delta=0.5980, p_bh=0.04115, d=1.389 (large)
- pred_span_quartile / Q1 / rank2_rescue_on_miss1: delta=0.4841, p_bh=0.002158, d=1.110 (large)
- anomaly_direction / normal / rank2_rescue_on_miss1: delta=0.4206, p_bh=0.003611, d=0.910 (large)
- pred_span_quartile / Q1 / hit_at_2: delta=0.4074, p_bh=0.03342, d=1.098 (large)
- anomaly_direction / low_anomaly / hit_at_2: delta=0.2500, p_bh=0.0419, d=0.799 (medium)
- weekday / Monday / hit_at_2: delta=0.2167, p_bh=0.003193, d=0.738 (medium)
...
- anomaly_direction / high_anomaly / rank2_rescue_on_miss1: delta=0.5000, p_bh=nan, d=1.080 (large)
- pred_span_quartile / Q2 / rank2_rescue_on_miss1: delta=0.4091, p_bh=0.07296, d=0.923 (large)
- weekday / Thursday / rank2_rescue_on_miss1: delta=0.3833, p_bh=0.2962, d=0.770 (medium)
...
- anomaly_direction / high_anomaly / rank2_rescue_on_miss1: n_current=6, n_baseline=3
