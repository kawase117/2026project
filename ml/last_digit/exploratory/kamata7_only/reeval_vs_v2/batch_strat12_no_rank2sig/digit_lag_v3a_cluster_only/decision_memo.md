...
### hit_at_2
代表条件: `weekday/sunday`
Δ mean: +0.0159, CI=[+0.0000, +0.0476], p_BH=0.9519, d=0.103 (negligible)
有意改善: 0件, 有意悪化: 0件
→ 不変

### loss_value
代表条件: `anomaly_direction/anomaly`
Δ mean: -826.3158, CI=[-2300.0000, +45.6140], p_BH=0.9519, d=-0.219 (small)
有意改善: 0件, 有意悪化: 0件
→ 不変
...
Δ mean: +0.0053, CI=[-0.0053, +0.0160], p_BH=0.9519, d=0.046 (negligible)
有意改善: 0件, 有意悪化: 0件
→ 不変
