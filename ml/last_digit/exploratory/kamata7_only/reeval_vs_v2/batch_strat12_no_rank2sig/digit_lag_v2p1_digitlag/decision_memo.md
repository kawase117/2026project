...
Δ mean: +0.0175, CI=[+0.0000, +0.0526], p_BH=0.6815, d=0.187 (negligible)
有意改善: 0件, 有意悪化: 0件
→ 不変

### loss_value
代表条件: `anomaly_direction/normal`
Δ mean: -79.4667, CI=[-337.8667, +180.8067], p_BH=0.6815, d=-0.027 (negligible)
有意改善: 0件, 有意悪化: 0件
→ 不変
...
### critical_miss_rate
代表条件: `anomaly_direction/anomaly`
Δ mean: -0.0175, CI=[-0.0526, +0.0000], p_BH=0.6815, d=-0.187 (negligible)
有意改善: 0件, 有意悪化: 0件
→ 不変
