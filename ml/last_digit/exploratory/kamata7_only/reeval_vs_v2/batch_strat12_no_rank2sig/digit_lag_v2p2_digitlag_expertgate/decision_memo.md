...
Δ mean: +0.0175, CI=[+0.0000, +0.0526], p_BH=0.7241, d=0.187 (negligible)
有意改善: 0件, 有意悪化: 0件
→ 不変

### loss_value
代表条件: `anomaly_direction/normal`
Δ mean: +8.0000, CI=[-272.5333, +313.6067], p_BH=0.7241, d=0.002 (negligible)
有意改善: 0件, 有意悪化: 0件
→ 不変
...
### critical_miss_rate
代表条件: `anomaly_direction/anomaly`
Δ mean: -0.0175, CI=[-0.0526, +0.0000], p_BH=0.7241, d=-0.187 (negligible)
有意改善: 0件, 有意悪化: 0件
→ 不変
