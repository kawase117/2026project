...
- anomaly_direction / low_anomaly / loss_value: delta=-2500.0000, p_bh=0.03319, d=-0.795 (medium)
- anomaly_direction / normal / loss_value: delta=-1047.7333, p_bh=0.0002186, d=-0.241 (small)
- weekday / Saturday / loss_value: delta=-928.5714, p_bh=0.04077, d=-0.432 (small)
- weekday / Saturday / rank2_rescue_on_miss1: delta=0.7000, p_bh=0.03725, d=1.807 (large)
- weekday / Wednesday / rank2_rescue_on_miss1: delta=0.5980, p_bh=0.04077, d=1.389 (large)
- pred_span_quartile / Q1 / rank2_rescue_on_miss1: delta=0.4678, p_bh=0.003144, d=1.068 (large)
- pred_span_quartile / Q1 / hit_at_2: delta=0.4074, p_bh=0.04077, d=1.098 (large)
- anomaly_direction / normal / rank2_rescue_on_miss1: delta=0.3933, p_bh=0.009236, d=0.845 (large)
- anomaly_direction / low_anomaly / critical_miss_rate: delta=-0.2500, p_bh=0.04077, d=-0.799 (medium)
- anomaly_direction / low_anomaly / hit_at_2: delta=0.2500, p_bh=0.04077, d=0.799 (medium)
...
- pred_span_quartile / Q1 / critical_miss_rate: delta=-0.3981, p_bh=0.1117, d=-1.039 (large)
- pred_span_quartile / Q2 / rank2_rescue_on_miss1: delta=0.4091, p_bh=0.07156, d=0.923 (large)
- weekday / Thursday / rank2_rescue_on_miss1: delta=0.3833, p_bh=0.3028, d=0.770 (medium)
- difficulty_failure / miss_day / rank2_rescue_on_miss1: delta=0.1365, p_bh=0.4356, d=0.520 (medium)
