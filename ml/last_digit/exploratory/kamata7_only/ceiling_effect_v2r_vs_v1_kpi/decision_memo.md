...
Δ mean: +0.1280, CI=[+0.0933, +0.1627], p_BH=6.471e-10, d=0.510 (medium)
有意改善: 7件, 有意悪化: 0件
→ 改善

### loss_value
代表条件: `anomaly_direction/normal`
Δ mean: -1047.7333, CI=[-1614.1667, -502.1333], p_BH=0.0002186, d=-0.241 (small)
有意改善: 3件, 有意悪化: 0件
→ 改善

### rank2_rescue_on_miss1
代表条件: `pred_span_quartile/Q1`
Δ mean: +0.4678, CI=[+0.2213, +0.6919], p_BH=0.003144, d=1.068 (large)
有意改善: 4件, 有意悪化: 0件
→ 改善

### critical_miss_rate
代表条件: `anomaly_direction/normal`
Δ mean: -0.1227, CI=[-0.1600, -0.0880], p_BH=5.078e-09, d=-0.471 (small)
有意改善: 6件, 有意悪化: 0件
→ 改善
