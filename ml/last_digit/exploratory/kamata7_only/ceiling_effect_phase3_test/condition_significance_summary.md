...
- anomaly_direction / low_anomaly / loss_value: delta=-2500.0000, p_bh=0.0326, d=-0.795 (medium)
- weekday / Sunday / loss_value: delta=-1741.6667, p_bh=0.02635, d=-0.420 (small)
- anomaly_direction / normal / loss_value: delta=-1131.9892, p_bh=9.844e-05, d=-0.292 (small)
- weekday / Saturday / loss_value: delta=-928.5714, p_bh=0.03576, d=-0.432 (small)
- weekday / Saturday / rank2_rescue_on_miss1: delta=0.7000, p_bh=0.03267, d=1.807 (large)
- weekday / Wednesday / rank2_rescue_on_miss1: delta=0.5980, p_bh=0.03576, d=1.389 (large)
- pred_span_quartile / Q1 / rank2_rescue_on_miss1: delta=0.5581, p_bh=0.000743, d=1.302 (large)
- anomaly_direction / normal / rank2_rescue_on_miss1: delta=0.5222, p_bh=0.0008503, d=1.160 (large)
- pred_span_quartile / Q2 / rank2_rescue_on_miss1: delta=0.5000, p_bh=0.03267, d=1.225 (large)
- pred_span_quartile / Q1 / hit_at_2: delta=0.4151, p_bh=0.03576, d=1.116 (large)
...
- weekday / Thursday / rank2_rescue_on_miss1: delta=0.3833, p_bh=0.301, d=0.770 (medium)
- difficulty_failure / miss_day / rank2_rescue_on_miss1: delta=0.1365, p_bh=0.4076, d=0.520 (medium)
- weekday / Sunday / rank2_rescue_on_miss1: delta=0.2083, p_bh=nan, d=0.503 (medium)
...
- pred_span_quartile / Q3 / rank2_rescue_on_miss1: n_current=2, n_baseline=6
...
- weekday / Sunday / rank2_rescue_on_miss1: n_current=3, n_baseline=8
