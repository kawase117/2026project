...
- pred_span_quartile / Q1 / loss_value: delta=-2855.5556, p_bh=0.02674, d=-0.449 (small)
- weekday / Wednesday / loss_value: delta=-2563.3333, p_bh=0.0233, d=-0.490 (small)
- anomaly_direction / low_anomaly / loss_value: delta=-2395.8333, p_bh=0.0421, d=-0.748 (medium)
- weekday / Sunday / loss_value: delta=-1695.2381, p_bh=0.02514, d=-0.336 (small)
- anomaly_direction / normal / loss_value: delta=-1103.2000, p_bh=0.000183, d=-0.276 (small)
- pred_span_quartile / Q1 / hit_at_2: delta=0.3981, p_bh=0.009921, d=1.056 (large)
...
- pred_span_quartile / Q2 / rank2_rescue_on_miss1: delta=0.4091, p_bh=0.07838, d=0.923 (large)
- anomaly_direction / low_anomaly / rank2_rescue_on_miss1: delta=0.4167, p_bh=nan, d=0.849 (large)
- anomaly_direction / normal / rank2_rescue_on_miss1: delta=0.3183, p_bh=0.05266, d=0.677 (medium)
- pred_span_quartile / Q1 / rank2_rescue_on_miss1: delta=0.3004, p_bh=0.07838, d=0.675 (medium)
- weekday / Sunday / rank2_rescue_on_miss1: delta=0.3000, p_bh=0.3009, d=0.632 (medium)
...
- weekday / Sunday / rank2_rescue_on_miss1: n_current=8, n_baseline=10
